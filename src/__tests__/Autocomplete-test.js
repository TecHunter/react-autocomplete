...
import { getCategorizedStates, getStates, matchStateToTermWithHeaders } from '../utils'
import * as ReactDOM from 'react-dom'
import Adapter from 'enzyme-adapter-react-16';

Enzyme.configure({ adapter: new Adapter() });

const AutocompleteComponentJSX = (extraProps = {}) => (
	<Autocomplete
...
it('renders without crashing', () => {
	...
	ReactDOM.render(<AutocompleteComponentJSX/>, div)
